...
export const ResultsCard = () => {
  ...
  return (
    <section className='w-[90%] max-w-md mx-auto bg-white shadow-2xl md:flex md:rounded-2xl md:max-w-4xl'>
        <article className='bg-gradient-to-b from-light-slate-blue to-light-slate-blue rounded-b-2xl p-10 text-white text-center md:rounded-2xl md:w-1/2 md:grid md:content-center'>
          <p className="text-xl font-bold text-light-lavander">Your result</p>
          ...
          <div className="w-36 aspect-square bg-gradient-to-b from-violet-blue to-persian-blue rounded-full mx-auto my-8 grid content-center md:w-56">
            ...
            <p className="font-bold text-light-lavander">of 100</p>
          </div>

          <h3 className="text-3xl mb-4 font-bold">Great</h3>
          <p className="text-light-lavander">You scored higher than 65% of the people who have taken these tests.</p>
        </article>
        ...
        <article className="p-10 grid gap-6 md:w-1/2">
          ...
          <div className="bg-orange-yellow/5 rounded-xl flex py-5 px-6 items-center">
            <img src="" alt="" />
            <p className="ml-3 text-orange-yellow text-lg">Memory</p>
            <p className="ml-auto font-bold text-dark-gray-blue">
              92
              <span className="text-dark-gray-blue/70">/ 100</span>
            </p>
          ...
          <a onClick={handleClick} className="bg-dark-gray-blue text-white rounded-full py-5 text-center font-bold hover:bg-gradient-to-b from-light-slate-blue to-light-royal-blue dark:hover:text-black" href="#">{text}</a>
        </article>
